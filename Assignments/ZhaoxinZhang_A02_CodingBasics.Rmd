...
3. Compare the mean and median to see if the mean is greater than the median. If it is greater, the printed result will be TRUE, if it is not, the printed result will be FALSE. In the Console we can see a FALSE, which means that the mean is not greater than the median.
