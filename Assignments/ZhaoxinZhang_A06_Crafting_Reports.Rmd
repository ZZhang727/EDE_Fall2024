...
knitr::kable(summary_PM25, caption = "Table 2 Mean Particulates (2.5mm)", col.names = c("County", "$\\mu g/m^3$"))

knitr::kable(summary_Ozone, caption = "Table 3 Mean Ozone", col.names = c("County", "$\\mu g/m^3$"))
...
---
```{r, fig.cap= "Ozone levels by month 2018", echo=FALSE, warning=FALSE, fig.align='left', fig.height=4}
Ozone_2018 <-filter(epa_data,Year == "2018")
Ozone_2018$Month<-factor(Ozone_2018$Month,
levels=1:12,
labels = month.abb)
ggplot(Ozone_2018, aes(x=Month, y=Ozone, groupMonth))+
  geom_boxplot()+
  labs(title = "Ozone Levels by Month Year 2018",
       x= "Month",
       y = "Ozone Level")
```
```{r, fig.cap= "Ozone levels by month 2019", echo=FALSE,warning=FALSE, fig.align='left', fig.height=4}
Ozone_2019 <-filter(epa_data,Year == "2019")
Ozone_2019$Month<-factor(Ozone_2019$Month,
levels=1:12,
labels = month.abb)
ggplot(Ozone_2019, aes(x=Month, y=Ozone, groupMonth))+
  geom_boxplot()+
  labs(title = "Ozone Levels by Month Year 2019",
       x= "Month",
       y = "Ozone Level")
```
...
## Git Repository
https://github.com/ZZhang727/EDE_Fall2024/tree/main/Assignments
