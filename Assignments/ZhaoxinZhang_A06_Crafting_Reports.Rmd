...
```{r, fig.cap= "2018 monthly Ozone levels", echo=FALSE, warning=FALSE, fig.align='left', fig.height=3}
...
ggplot(Ozone_2018, aes(x=Month, y=Ozone, groupMonth))+
  ...
  labs(title = "Monthly Ozone concentrations (2019)",
       x= "Month",
       y = "Concentration ($\\mu g/m^3$)")
```

```{r, fig.cap= "2019 monthly Ozone levels", echo=FALSE,warning=FALSE, fig.align='left', fig.height=3}
