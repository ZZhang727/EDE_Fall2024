...
#It is the third number in vector1, which is 5.3
max(vector1)
...
#Combine vector1 and vector4, the little c means "combine"
c(vector1, vector4)

#first*first, 2nd*2nd.....
vector1 * vector4

#Multiple all numbers by 10 
vector1 * 10

#Convert all to upper case:
toupper(vector2) 

#!means negative, which is opposite of what we did before
!vector3
...
#Dataframe needs to have the same number of rows
